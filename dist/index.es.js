...
var useRequest = function useRequest(configuration) {
  ...
  var _useState = useState({ isLoading: false, isSuccess: false, isFailed: false }),
      _useState2 = slicedToArray(_useState, 2),
      state = _useState2[0],
      setState = _useState2[1];
...
var Request = function Request(props) {
  ...
  var render = function render() {
    if (typeof Component === 'function' || React.isValidElement(Component)) {
      return React.createElement(Component, rendererProps);
    }
...
export { RequestConfig, RequestStore, RequestNamespace, Request, useRequest, withRequest };
