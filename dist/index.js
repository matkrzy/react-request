...
var RequestContext = React.createContext();
...
var RequestStore = function RequestStore(props) {
  var _useState = React.useState({}),
      _useState2 = slicedToArray(_useState, 2),
      state = _useState2[0],
      setState = _useState2[1];

  var registerNamespace = function registerNamespace(namespace) {
    return setState(function (prevState) {
      return _extends({}, prevState, defineProperty({}, namespace, {}));
    });
  };
  var unregisterNamespace = function unregisterNamespace(namespace) {
    return setState(function (prevState) {
  ...
  var updateNamespace = function updateNamespace(namespace, value) {
    return setState(function (prevState) {
      return _extends({}, prevState, defineProperty({}, namespace, value));
    });
  };
  ...
  return React__default.createElement(
    ...
    { value: { state: state, registerNamespace: registerNamespace, unregisterNamespace: unregisterNamespace, updateNamespace: updateNamespace } },
    children
  );
};

var RequestNamespace = function RequestNamespace(props) {
  ...
  return React__default.createElement(
    ...
    null,
    function (values) {
      var data = values.state[namespace];
...
var prepareEndpointUrl = function prepareEndpointUrl(endpoint) {
  if (!endpoint) {
    throw new Error('endpoint is required');
  }

  var prefixesExcludedFromAPI = RequestConfig.excludedPrefixesFromApi;

  if (prefixesExcludedFromAPI.some(function (prefix) {
...
var prepareAction = function prepareAction(_ref) {
  var action = _ref.action,
      data = _ref.data,
      params = _ref.params;

  if (typeof action === 'function') {
    return action({ data: data, params: params });
  }

  return { type: action };
};

var executeRequest$$1 = function executeRequest$$1(_ref) {
  var axiosInstance = _ref.axiosInstance,
      _ref$data = _ref.data,
      dataFromProps = _ref$data === undefined ? {} : _ref$data,
      _ref$dataKey = _ref.dataKey,
      dataKey = _ref$dataKey === undefined ? RequestConfig.dataKey : _ref$dataKey,
      _ref$errorKey = _ref.errorKey,
      errorKey = _ref$errorKey === undefined ? RequestConfig.errorKey : _ref$errorKey,
  ...
  return function () {
    ...
    //set request params
    axiosInstance.defaults.params = _extends({}, params ? params : {}, paramsFromProps ? paramsFromProps : {});
    ...
    if (reduxActionTypes && reduxActionTypes[0]) {
      // $FlowFixMe
      dispatchReduxAction(prepareAction({ action: reduxActionTypes[0], params: params }));
    }

    axiosInstance.request().then(function (response) {
      ...
      if (reduxActionTypes && reduxActionTypes[1]) {
        dispatchReduxAction(prepareAction({ action: reduxActionTypes[1], params: params, data: data }));
      }
      ...
      if (!axios.isCancel(error)) {
        ...
        if (reduxActionTypes && reduxActionTypes[2]) {
          // $FlowFixMe
          dispatchReduxAction(prepareAction({ action: reduxActionTypes[2], params: params }));
        }
...
var dispatchReduxAction = function dispatchReduxAction(action) {
  //get store dispatch from configuration object
  var _ref = RequestConfig.store || {},
...
var createAxiosInstance = function createAxiosInstance(_ref) {
  ...
  var cancelRequest = CancelToken.source();
...
var useRequest = function useRequest(configuration) {
  var _configuration$abortO = configuration.abortOnUnmount,
      ...
      _configuration$method = configuration.method,
      method = _configuration$method === undefined ? 'get' : _configuration$method,
      onFailure = configuration.onFailure,
      onSuccess = configuration.onSuccess,
      params = configuration.params,
      reduxActionTypes = configuration.reduxActionTypes,
      _configuration$reques = configuration.requestOnDataChange,
      requestOnDataChange = _configuration$reques === undefined ? true : _configuration$reques,
      _configuration$reques2 = configuration.requestOnEndpointChange,
      requestOnEndpointChange = _configuration$reques2 === undefined ? true : _configuration$reques2,
      _configuration$reques3 = configuration.requestOnMount,
      requestOnMount = _configuration$reques3 === undefined ? true : _configuration$reques3,
      _configuration$reques4 = configuration.requestOnParamsChange,
      requestOnParamsChange = _configuration$reques4 === undefined ? true : _configuration$reques4;

  //initialize state

  var _useState = React.useState({ isLoading: false, isSuccess: false, isFailed: false }),
      _useState2 = slicedToArray(_useState, 2),
      state = _useState2[0],
      setState = _useState2[1];
  ...
  var _createAxiosInstance = createAxiosInstance({ endpoint: endpoint, method: method }),
      axiosInstance = _createAxiosInstance.axiosInstance,
      cancelRequest = _createAxiosInstance.cancelRequest;

  //prepare request executor


  var doRequest = executeRequest$$1({
  ...
  var updateData = function updateData(data) {
    return setState(function (prevState) {
      return _extends({}, prevState, { data: data });
    });
  };
  ...
  return { state: state, doRequest: doRequest, updateData: updateData, cancelRequest: cancelRequest };
};

var ConsumerWrapper = function ConsumerWrapper(props) {
  var registerNamespace = props.registerNamespace,
      unregisterNamespace = props.unregisterNamespace,
      updateNamespace = props.updateNamespace,
...
var RequestContextConsumer = function RequestContextConsumer(props) {
  return React__default.createElement(
    RequestContext.Consumer,
    null,
    function (values) {
      return React__default.createElement(
        ConsumerWrapper,
        _extends({}, values, { data: props.data, namespace: props.namespace }),
        props.children
      );
    }
  );
...
var Request = function Request(props) {
  var Component = props.component,
      ...
      namespace = props.namespace,
      configuration = objectWithoutProperties(props, ['component', 'children', 'namespace']);

  //configure request hook

  var _useRequest = useRequest(configuration),
      state = _useRequest.state,
      doRequest = _useRequest.doRequest,
      updateData = _useRequest.updateData,
      cancelRequest = _useRequest.cancelRequest;

  //renderer props


  var rendererProps = _extends({}, state, { doRequest: doRequest, updateData: updateData, cancelRequest: cancelRequest });

  //select proper renderer
  var render = function render() {
    if (typeof Component === 'function' || React__default.isValidElement(Component)) {
      return React__default.createElement(Component, rendererProps);
    }
  ...
  if (namespace) {
    return React__default.createElement(
      ...
      { namespace: namespace, data: state.data },
      render()
    );
  }
...
var withRequest = function withRequest(_ref) {
  var namespace = _ref.namespace,
      configuration = objectWithoutProperties(_ref, ['namespace']);
  return function (WrappedComponent) {
    return function (props) {
      ...
      var componentProps = _extends({}, state, { doRequest: doRequest, cancelRequest: cancelRequest }, props);

      if (namespace) {
        return React__default.createElement(
          RequestContextConsumer,
          { namespace: namespace, data: state.data },
          React__default.createElement(WrappedComponent, componentProps)
        );
      }

      return React__default.createElement(WrappedComponent, componentProps);
    };
  };
};
...
exports.RequestNamespace = RequestNamespace;
